                ...
                <form key={this.props.project.id}>
                    ...
                    <div >
                        <FormGroup controlId="start_date">
                            ...
                            <DateField placeholder="Select Date" onChange={this.props.handleStartDateChange} value={this.props.project.startdate} dateFormat={DATEFORMAT} footer={false} updateOnDateClick={true} collapseOnDateClick={true} disabled={!this.props.canEdit}/>
                        </FormGroup>
                        <FormGroup controlId="end_date">
                            <div>
                                <ControlLabel>Expected End Date:</ControlLabel>
                            </div>
                            <DateField placeholder="Select Date" onChange={this.props.handleEndDateChange} value={this.props.project.enddate} dateFormat={DATEFORMAT} footer={false} updateOnDateClick={true} collapseOnDateClick={true} disabled={!this.props.canEdit} />
                        </FormGroup>
                    </div>
                    ...
                    <div >{
                        this.props.canEdit ? <span className='splitButton'><button type="button" className='btn btn-primary btn-large' onClick={this.props.handleSave}>Save</button></span> : <span className='splitButton'><button type="button" className='btn btn-primary btn-large' onClick={this.props.handleEdit}>Edit</button></span>
                    }
                    </div>
                </form>
                <div>
